...
function Home() {
  ...
  return (
      ...
      <div className="flex flex-col items-center justify-center text-center px-8 py-32">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="bg-green-600 text-white font-bold px-8 py-4 rounded-full hover:bg-green-700 transition"
          >
            Find talent
          </button>
          <button
            onClick={() => navigate('/register')}
            className="bg-gray-800 text-white font-medium px-8 py-4 rounded-full border border-gray-700 hover:border-green-500 transition"
          >
            Find work
          </button>
        </div>
    ...
    <div className="bg-gray-900 border-y border-gray-800 py-8">
        <div className="max-w-5xl mx-auto grid grid-cols-4 divide-x divide-gray-800">
        {[
      ...
      <div key={label} className="text-center px-8">
        <p className="text-white text-3xl font-bold">{num}</p>
...
<div className="py-20 text-center px-8">
  ...
  <p className="text-gray-400 mb-8">Join thousands of Kenyan professionals already on WorkLinkKE</p>
  <button
    onClick={() => navigate('/register')}
    className="bg-green-600 text-white font-bold px-10 py-4 rounded-full hover:bg-green-700 transition"
  >
    Join WorkLinkKE
  </button>
</div>
